...
const Footer = () => {
    return (
        <div className="p-10 mx-auto text-white footer-bg max-w-7xl">
            <div className="grid items-start justify-between w-full max-w-6xl grid-cols-2 gap-10 mx-auto sm:grid-cols-2 md:grid-cols-4">
                <div className='flex flex-col max-w-xs gap-2 text-justify About-us'>
                    <h3 className='text-start'>About Us</h3>

                    <div className='text-sm text-left text-slate-200'>
                        <p className='text-xs footer-text'>We are a team of designers and developers that create high-quality websites.</p>
                        <div className="flex gap-4 mt-3 md:place-self-center md:justify-self-end">
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <hr />
                    <div className="flex flex-col gap-1 text-xs text-left text-white ">
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <hr />
                    <div className='flex flex-col gap-1 text-xs text-left sm:text-sm text-slate-200'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <p className='text-xs footer-text text-slate-200'>Subscribe to our site to show your support and stay up-to-date with the latest toys</p>
                </div>
