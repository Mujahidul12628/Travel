...
//             <div className="flex items-center navbar-end ">
//                 {
//                     <label className="swap swap-rotate px-1 md:px-4">
...
//                 }
//                 {
//                     user && <div className="w-10 h-10 mr-5 bg-cyan-600 rounded-full tooltip tooltip-bottom" data-tip={user?.displayName}>
//                         <img className='w-10 h-10 rounded-full' src={user?.photoURL} />
//                     </div>
//                 }
//                 {
//                     user ? <button onClick={handleLogout} className="px-2 py-1 md:py-2 text-white rounded-md logged-in-out">
//                         <Link to='/'>Log Out</Link>
//                     </button>
//                         : <button className="px-2 py-1 md:py-2 text-white rounded-md logged-in-out">
        ...
        <div className="w-full mx-auto font-semibold text-white navbar max-w-7xl navbar-bg" >
            ...
            <div className="navbar-start ">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="p-2 mt-3 shadow  menu menu-compact dropdown-content rounded-box w-44 btn-bg bg-cyan-600 ">
                        <li><NavLink className={({ isActive, isPending }) => isActive ? "active-link" : isPending ? "pending" : ""} to='/'>Home</NavLink ></li>
                        <li><NavLink className={({ isActive, isPending }) => isActive ? "active-link" : isPending ? "pending" : ""} to='/class'>Class</NavLink ></li>
                        <li><NavLink className={({ isActive, isPending }) => isActive ? "active-link" : isPending ? "pending" : ""} to='/instructor'>Instructor</NavLink ></li>
                        <li><NavLink className={({ isActive, isPending }) => isActive ? "active-link" : isPending ? "pending" : ""} to='/dashboard'>Dashboard</NavLink ></li>
                    </ul>
                </div>
                <Link to='/' className="text-2xl font-semibold "><span className='text-[#ffffff]'>
                    {/* <img className="h-[60%] w-[60%] object-contain sm:h-[40%] sm:w-[40%] md:h-[50%] md:w-[50%]" src={logo} alt="" /> */}
            ...
            <div className="hidden navbar-center md:flex">
                <ul className="gap-2 px-1 menu menu-horizontal text-white">
                    <li><NavLink className={({ isActive, isPending }) => isActive ? "active-link" : isPending ? "pending" : ""} to='/'>Home</NavLink></li>
                    <li><NavLink className={({ isActive, isPending }) => isActive ? "active-link" : isPending ? "pending" : ""} to='/class'>Class</NavLink></li>
                    <li><NavLink className={({ isActive, isPending }) => isActive ? "active-link" : isPending ? "pending" : ""} to='/instructor'>Instructor</NavLink></li>
                    <li><NavLink className={({ isActive, isPending }) => isActive ? "active-link" : isPending ? "pending" : ""} to='/dashboard'>Dashboard</NavLink></li>
